...
Rscript ${cyto_sv_ml_dir}/Pipeline_script/interface_data.R -i ${main_dir}'/out/'${sample_all}'/'${sample_all} -o ${cyto_sv_ml_dir}"/cyto-sv-ml/data/cyto_sv_ml.RData" -c ${cyto_band_file}
cd ${cyto_sv_ml_dir}"/"
