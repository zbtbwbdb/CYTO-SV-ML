...
python ${cyto_dv_ml_dir}/Pipeline_script/sv_info_tf_sim.py  ${main_dir}/out/${sample}/${sample}.10k.nontrs_tf.all SUPP
python ${cyto_dv_ml_dir}/Pipeline_script/sv_consolidate_id_mapping.py ${main_dir}/out/${sample}/${sample}.10k.sv.all 

echo "# SV vcf simplified transformation" && date
python ${cyto_dv_ml_dir}/Pipeline_script/sv_vcf_sim.py ${main_dir}/out/${sample}/${sample}.10k.sv.all
