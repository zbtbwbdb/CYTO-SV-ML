...
ls ${main_dir}/out/${sample}/sv_caller_results/${sample}.*.vcf.${size_k}k.nontrs_tf | grep -v svtype > ${main_dir}/out/${sample}/sv_caller_results/${sample}.${size_k}k.nontrs_tf.list
...
ls ${main_dir}/out/${sample}/sv_caller_results/${sample}.*.vcf.${size_k}k.*trs_tf | grep -v svtype > ${main_dir}/out/${sample}/sv_caller_results/${sample}.${size_k}k.all.list
