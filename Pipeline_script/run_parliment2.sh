...
cp ${main_dir}/reference/hg38/hs38.fasta ${main_dir}/in/reference/hg38/hs38.fasta
cp ${main_dir}/reference/hg38/hs38.fasta.fai ${main_dir}/in/reference/hg38/hs38.fasta.fai
